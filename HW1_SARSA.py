...
# The following function is the update rule for the Q function for SARSA algorithm 
def update(state, next_state, reward, action, next_action, Q, alpha):
    ...
    """  
     Args:
        ...
        next_action: Next actin derived from epsilon-greedy Q 
        alpha: Learning rate 
...
def SARSA(env, epsilon, alpha, gamma, total_episodes, max_steps):
    ...
    Returns:
        The learned optimal policy as well as the trajectory 
    """
    ...
    for episode in range(total_episodes):     
        ...
        while t < max_steps:
            ...
            update(state, next_state, reward, action, next_action, Q, alpha)
...
epsilon = 0.1
alpha = 0.9
policy = SARSA(env, epsilon, alpha, gamma, total_episodes, max_steps)
